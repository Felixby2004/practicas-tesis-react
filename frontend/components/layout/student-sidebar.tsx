      ...
      <div className={cn(
        ...
        <div className={cn(
          ...
          <div className={cn(
            ...
            {!collapsed && (
              <div>
                <h1 className="text-lg font-bold text-primary">UNT Estudiante</h1>
                <p className="text-xs text-muted-foreground">Área Personal</p>
              </div>
            )}
            {collapsed && (
          ...
          <div className={cn(
            ...
            {!collapsed && (
              <div className="flex-1 overflow-hidden">
                <p className="text-sm font-medium truncate">{user.nombre_completo || 'Estudiante'}</p>
